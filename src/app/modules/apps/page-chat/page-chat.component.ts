...
import { ViewTextMediaComponent } from '../../base/view-text-media/view-text-media.component';
@Component({
  selector: 'app-page-chat',
  standalone: true,
  imports:  [CommonModule, SharedModule, EmojiPickerComponent, ViewTextMediaComponent],
